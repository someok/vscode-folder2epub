...
## 核心组件
- 扩展入口与命令注册：在激活时注册所有命令，包括“生成 EPUB”“初始化 EPUB”“新增 .t2eignore”“配置默认作者”。
...
## 故障排查指南
- 缺少元数据文件
  - 现象：执行“生成 EPUB”提示缺少 __t2e.data/metadata.yml。
